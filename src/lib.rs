...
#[derive(Debug)]
pub struct AccessGuardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AccessGuardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AccessGuard processing");
    
    let mut processor = AccessGuardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AccessGuardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AccessGuardProcessor::new(false);
